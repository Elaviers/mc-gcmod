                ...
                if (!isSneaking) {
                    ...
                    if (counter == 8) {
                        ...
                        if (time - timeOfLastPooing > 300 && time - counterStartTime <= 40) {
                            this.player.world.addEntity(new PooEntity(this.player.world, this.player.posX, this.player.posY, this.player.posZ));
                            this.player.world.playSound(null, this.player.posX, this.player.posY, this.player.posZ, StupidModSounds.FART, SoundCategory.MASTER, 1.f, 1.f);
