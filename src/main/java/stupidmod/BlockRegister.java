...
import stupidmod.item.ItemBasic;
...
public class BlockRegister {
    ...
    public static ItemBlock itemBlockRope;
    ...
    private static class Registration {
        ...
        static void registerItems(RegistryEvent.Register<Item> register) {
            ...
            registry.registerAll(
                    ...
                    new ItemBlock(blockRope, new Item.Properties().group(StupidMod.GROUP)).setRegistryName(nameRope)
            );
