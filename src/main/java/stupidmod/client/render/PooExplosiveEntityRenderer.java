...
public class PooExplosiveEntityRenderer extends EntityRenderer<PooExplosiveEntity> {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(PooExplosiveEntity entity) {
        return TEXTURE;
    }

    @Override
    public void doRender(PooExplosiveEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
