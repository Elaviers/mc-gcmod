...
public class ExplosionConstructive
{
    ...
    public ExplosionConstructive(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean damagesTerrain, IBlockState state)
    {
        ...
        this.explosion = new Explosion(this.world, this.exploder, this.x, this.y, this.z, this.size, this.causesFire, this.damagesTerrain);
                    ...
                    if (j == 0 || j == 15 || k == 0 || k == 15 || l == 0 || l == 15)
                    {
                        ...
                        for (float f1 = 0.3F; f > 0.0F; f -= 0.22500001F)
                        {
                            ...
                            if (iblockstate.getMaterial() != Material.AIR)
                            {
                                ...
                                float f2 = this.exploder != null ? this.exploder.getExplosionResistance(this.explosion, this.world, blockpos, iblockstate) : iblockstate.getBlock().getExplosionResistance(world, blockpos, (Entity)null, this.explosion);
                                f -= (f2 + 0.3F) * 0.3F;
                            }
