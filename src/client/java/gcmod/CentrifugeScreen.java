...
public class CentrifugeScreen extends AbstractContainerScreen<CentrifugeScreenHandler>
{
    ...
    public void extractBackground( GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a )
    {
        ...
        graphics.blit( RenderPipelines.GUI_TEXTURED, BG_TEX, x, y, 0f, 0f, this.imageWidth, this.imageHeight, 256, 256 );

        final float progress = Math.min( 1f, (float) this.menu.properties.get( 0 ) / CentrifugeEntity.PROCESS_DURATION_TICKS );
        graphics.blit( RenderPipelines.GUI_TEXTURED, BG_TEX, x + 79, y + 33, 176, 0, 18, (int) (progress * 19f), 256, 256 );
    }
